...
function __icon_map() {
   ...
   "Calculator" | "Calculette")
        ...
        ;;
   "Calendar" | "Fantastical" | "Cron" | "Amie" | "Calendrier" | "カレンダー" | "Notion Calendar")
   ...
   "Fusion")
        icon_result=":fusion:"
        ;;
   "System Preferences" | "System Settings" | "Réglages Système" | "システム設定")
        icon_result=":gear:"
        ;;
   "Ghostty")
        icon_result=":ghostty:"
   ...
   "Logseq")
        icon_result=":logseq:"
        ;;
   "Canary Mail" | "HEY" | "Mail" | "Mailspring" | "MailMate" | "Superhuman" | "Spark" | "メール")
        icon_result=":mail:"
        ;;
   "MAMP" | "MAMP PRO")
        icon_result=":mamp:"
   ...
   "Passwords")
        ...
        ;;
   "Preview" | "Skim" | "zathura" | "Aperçu" | "プレビュー")
        icon_result=":pdf:"
        ;;
   "PDF Expert")
